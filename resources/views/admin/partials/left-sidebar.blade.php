...
<ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
            <a class="dropdown-item" href="" class="nav-link"><i
    ...
    <li class="nav-item">
      ...
      <a class="nav-link" href="{{ route('bladeCategories') }} " id="userDropdown" role="button"
      ...
      <a class="nav-link" href="{{ route('bladeOrders') }} " id="userDropdown" role="button"
          data-toggle="" aria-haspopup="true" aria-expanded="false">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              class="bi bi-bicycle" viewBox="0 0 16 16">
              <path
